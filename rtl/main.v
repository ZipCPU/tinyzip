...
// DO NOT EDIT THIS FILE!
//
// CmdLine:	autofpga autofpga -o ../auto-generated global.txt bkram.txt buserr.txt clock50.txt pic.txt pwrcount.txt version.txt hbconsole.txt gpio.txt dlyarbiter.txt zipbones.txt flexpress.txt
//
...
// check
	...
	// from
	localparam	RESET_ADDRESS = 32'h00820000;
	//
...
// verilator lint_off UNUSED
	...
	wire	bus_interrupt;	// buspic.INT.BUS.WIRE
...
`endif
 ...
 // 0x000004
	assign	   flash_cfg_sel = ((wb_sio_sel)&&(wb_addr[ 2: 0] ==  3'h2));
 // 0x000008
...
//x2	Was a master bus as well
	...
	always	@(posedge i_clk)
		...
		casez( wb_addr[2:0] )
			...
			3'h2: r_wb_sio_data <= flash_cfg_data;
...
`else	// BUSPIC_ACCESS
	...
	assign	bus_interrupt = 1'b0;	// buspic.INT.BUS.WIRE
`endif	// BUSPIC_ACCESS
...
`ifdef	FLASH_ACCESS
	dualflexpress #(.LGFLASHSZ(23)) flashi(i_clk, i_reset,
