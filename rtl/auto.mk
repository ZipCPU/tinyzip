################################################################################
##
## Filename:	../auto-generated/rtl.make.inc
##
...
FLASH := dualflexpress.v

HBUART := txuartlite.v rxuartlite.v ufifo.v

VFLIST := main.v  $(ZIPCPU) $(BUSDLY) $(BUSPIC) $(GPIO) $(BKRAM) $(HBBUS) $(FLASH) $(HBUART)
AUTOVDIRS :=  -y cpu -y cpu -y cpu -y hexbus
