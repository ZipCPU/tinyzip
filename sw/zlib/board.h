...
#define	_BOARD_HAS_TIMER
static volatile unsigned *const _timer = ((unsigned *)2048);
#endif	// BUSTIMER_ACCESS
#define	_BOARD_HAS_VERSION
#define	_BOARD_HAS_BUSERR
static volatile unsigned *const _buserr = ((unsigned *)6144);
#ifdef	BUSPIC_ACCESS
#define	_BOARD_HAS_BUSPIC
static volatile unsigned *const _buspic = ((unsigned *)0x00001804);
#endif	// BUSPIC_ACCESS
#ifdef	GPIO_ACCESS
#define	_BOARD_HAS_GPIO
static volatile unsigned *const _gpio = ((unsigned *)6152);
#endif	// GPIO_ACCESS
#ifdef	BKRAM_ACCESS
...
static volatile CONSOLE *const _uart = ((CONSOLE *)0x00001000);
